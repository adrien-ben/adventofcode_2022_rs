...
fn main() {
    ...
    let divider = monkeys.iter().map(|m| m.test.division).product::<usize>();
    ...
    println!("monkey_business: {monkey_business}"); // 30893109657
}
